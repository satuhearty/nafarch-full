(function () {
  ...
  (function () {
    window.location.href = `${window.location.origin}${window.location.pathname}#announcement`;

    // Settings.
    var settings = {
      // Images (in the format of 'url': 'alignment').
      images: {
        "images/landing/bg01.jpg": "center",
        "images/landing/bg02.jpg": "center",
        "images/landing/bg03.jpg": "center",
      },
  ...
  (function () {
    ...
    $form.addEventListener("submit", function (event) {
      ...
      $.ajax({
        url: "https://formspree.io/nikamirulmukmeen@gmail.com",
        method: "POST",
        data: $(this).serialize(),
        dataType: "json",
      });
